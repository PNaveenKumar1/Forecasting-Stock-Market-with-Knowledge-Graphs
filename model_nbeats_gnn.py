...
# Initialize wandb
# wandb.init(project='stock_2_with_log_TRANS_DEC')
...
for tau in tau_choices:
    ...
    for phase in range(1,8):
        ...
        model  = Trans(backcast_length=5, forecast_length=1, theta_dim=20, units=10, stack_types=[1,2], num_blocks=1)
        if phase == 1:
            print(model)
        model.to(device)
